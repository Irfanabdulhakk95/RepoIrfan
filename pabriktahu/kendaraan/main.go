...
import (
	...
	ep "pabriktahu/kendaraan/endpoint"
...
func main() {
	...
	var server pb.KendaraanServiceServer
	{
		...
		service := svc.NewKendaraan(dbReadWriter)
		endpoint := ep.NewKendaraanEndpoint(service)
		fmt.Println(endpoint)
		server = ep.NewGRPCKendaraanServer(endpoint, tracer, logger)
	}
	...
	pb.RegisterKendaraanServiceServer(grpcServer, server)
