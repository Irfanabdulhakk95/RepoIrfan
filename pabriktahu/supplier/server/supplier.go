...
func (c *supplier) ReadSupplierByKeteranganService(ctx context.Context, keterangan string) (Suppliers, error) {
	kar, err := c.writer.ReadSupplierByKeterangan(keterangan)
